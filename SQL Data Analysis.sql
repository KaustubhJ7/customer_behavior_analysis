...
SELECT
	shipping_type,
    ROUND(AVG(purchase_amount), 2) "Average Purchase Amounts"
FROM customer
...
SELECT
    ...
    ROUND(AVG(purchase_amount), 2) "Average Spend",
    ROUND(AVG(purchase_amount), 2) "Total Revenue"
FROM customer
